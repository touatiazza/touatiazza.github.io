...
export function initInteractions() {
  ...
  // 6. Horizontal Drag-to-Scroll for Experience Carousel
  const swipeContainer = document.querySelector('.experience-swipe-container');
  if (swipeContainer) {
    let isDown = false;
    let startX;
    let scrollLeft;
    ...
    swipeContainer.addEventListener('mousedown', (e) => {
      ...
      swipeContainer.style.scrollSnapType = 'none';
    ...
    swipeContainer.addEventListener('mouseleave', resetDrag);
    swipeContainer.addEventListener('mouseup', resetDrag);
