...
export function initInteractions() {
  ...
  if (copyBtn) {
    copyBtn.addEventListener('click', (e) => {
      e.preventDefault();
      const email = 'azzatouati.ds@gmail.com'; // Direct contact email
      navigator.clipboard.writeText(email).then(() => {
        showToast('Email address copied to clipboard: azzatouati.ds@gmail.com');
      }).catch(() => {
        showToast('Contact Azza at: azzatouati.ds@gmail.com');
      });
    });
  }
