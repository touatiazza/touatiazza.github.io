...
export const skillsData = [
  ...
  { name: 'SOAP', category: 'backend', level: 'Core', context: 'Web services protocol integration for legacy enterprise system communications.' },

  // TOOLS & METHODOLOGIES
  { name: 'Git', category: 'tools', level: 'Advanced', context: 'Version control, branch management, code history & collaborative development.' },
  { name: 'GitLab', category: 'tools', level: 'Proficient', context: 'CI/CD pipeline configuration and repository management.' },
  { name: 'Jira', category: 'tools', level: 'Proficient', context: 'Agile project tracking, sprint planning & issue management.' },
  { name: 'Agile / Scrum', category: 'tools', level: 'Proficient', context: 'Iterative development, sprint planning, standups & team delivery.' }
];
...
export function initSkillsMatrix() {
  ...
  function renderSkills() {
    ...
    container.innerHTML = filtered.map(skill => `
      <div class="skill-card reveal-init">
        <div>
